...
public class VinnBuildPreferenceConstants {
  ...
  public static final String P_STRING_CONF_PROJECT_NAME = "com.build.conf.projectName";
  public static final String P_STRING_CONF_PROJECT_PATH = "com.build.conf.projectBasePath";
  public static final String P_STRING_CONF_PROJECT_DEPTH = "com.build.conf.projectSearchDepth";

  public static final String P_STRING_CONF_SELECTOR = "com.build.conf.selector";
