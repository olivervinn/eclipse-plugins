...
public class PreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    public PreferencePage() {
        ...
        setDescription("Settings for CDT project workspace");
    ...
    public void createFieldEditors() {
        ...
        addField(new BooleanFieldEditor(PreferenceConstants.P_AUTO_LINK_PROJECTS, "&Automatically link CDT projects",
