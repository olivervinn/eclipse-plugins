...
/**
 * A field editor for displaying and storing a list of strings. Buttons are provided for adding
 * items to the list and removing items from the list.
 */
public class AddRemoveListFieldEditor extends FieldEditor {
  ...
  public AddRemoveListFieldEditor(String name, String labelText, String addButtonText,
      String removeButtonText, Composite parent) {
    super(name, labelText, parent);
  ...
  private void add() {
    ...
    if (tag != null && tag.length() > 0) list.add(tag);
    textField.setText("");
  }
  ...
  /**
   * Sets the string that seperates items in the list when the list is stored as a single String in
